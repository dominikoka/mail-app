...
<div class="received">
  ...
  <div class="emailSender emailSender-height">
    ...
    <div class="emailSender_content">
      <div class="content">
        <div class="content_box">
          <div class="content_title"> CHECK YOUR LAST HISTORY:</div>
          <div class="content_legend">
            <ul class="Legend">
              <li class="Legend-item">
              <span class="Legend-colorBox Legend-colorGreen">
              </span>
              ...
              <li class="Legend-item">
              <span class="Legend-colorBox Legend-colorYellow">
              </span>
              <span class="Legend-label">
                READ MESSAGE
              </span>
              ...
              <li class="Legend-item">
              <span class="Legend-colorBox Legend-colorBlue">
              </span>
              <span class="Legend-label">
                DELETED MESSAGE
              </span>
        ...
        <div class="Content_messages">
          ...
          <%
            ...
            for(int i = 0;i<sentItem.size();i++)
            {
              ...
              out.print("<li class=\"accordeon_li activity_item\">");
              out.print("<a href='#' class=\"acc_items_a acc_activity_a\"><i class=\"fa fa-graduation-cap\"></i><div class=\"accordeonItem_msg "+sentItem.get(i).get(0)+"\"><div class=\"accordeonItem_from\">"+sentItem.get(i).get(1)+ "</div> <div class=\"accordeonItem_title\">"+subject+"</div> <div class=\"accordeonItem_date\">"+sentItem.get(i).get(5)+"</div></div></a>");
              out.print("<ul class='sub-items'>");
              out.print("<div class=\"accordeon_msg\">");
              out.print("<div class=\"msg_msg msg_activity\">");
